...
public class AccountClientExpectTest extends BaseRestClientExpectTest<SoftLayerApi> {
   ...
   public void testGetActivePackagesWhenResponseIs2xx() {
      ...
      SoftLayerApi client = requestSendsResponse(HttpRequest.builder().method("GET")
      ...
      assertEquals(client.getAccountApi().getActivePackages(),
              ImmutableSet.of(
   ...
   public void testGetActivePackagesWhenResponseIs404() {
      SoftLayerApi client = requestSendsResponse(HttpRequest.builder()
                        .method("GET")
                        .endpoint("https://api.softlayer.com/rest/v3/SoftLayer_Account/ActivePackages.json")
                        .addHeader("Accept", "application/json")
                        .addHeader("Authorization", "Basic aWRlbnRpdHk6Y3JlZGVudGlhbA==")
      ...
      assertEquals(client.getAccountApi().getActivePackages(), null);
   }

   public void testGetReducedActivePackagesWhenResponseIs2xx() {
      SoftLayerApi client = requestSendsResponse(
      ...
      assertEquals(client.getAccountApi().getReducedActivePackages(),
             ImmutableSet.of(
                     ProductPackage.builder()
                             .id(13)
                             .name("Dual Xeon (Dual Core) Woodcrest/Cloverton")
   ...
   public void testGetReducedActivePackagesWhenResponseIs404() {
      SoftLayerApi client = requestSendsResponse(
             ...
             HttpResponse.builder()
                     .statusCode(404)
                     .build());
      assertEquals(client.getAccountApi().getReducedActivePackages(), null);
   }
